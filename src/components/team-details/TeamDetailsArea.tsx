...
export default function TeamDetailsArea() {
  ...
  return (
    <>
      ...
      <div className="section-team">
        ...
        <div className="section-space">
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 items-center gap-x-[60px] gap-y-10 lg:grid-cols-[minmax(0,0.75fr)_1fr] lg:gap-x-20 xl:gap-x-[100px]">
              {/* <!-- Team details Left Side Block --> */}
              <div className="jos mx-auto max-w-[495px] overflow-hidden rounded-[25px] border-2 border-black lg:max-w-full lg:border-[5px]" data-jos_animation="fade-right">
                <img src="assets/img/images/th-1/team-details-img.jpg" alt="team-details-img" width="484" height="489" className="h-auto w-full object-cover" />
              </div>
              {/* <!-- Team details Left Side Block --> */}
              ...
              <div className="jos" data-jos_animation="fade-left">
                <article className="rich-text">
                  ...
                  <div className="text-lg leading-[1.43] lg:text-[21px]">
                    <p>
      ...
      <section className="section-team-details-info">
        {/* <!-- Section Space --> */}
              ...
              <li className="jos">
                ...
                <ul className="ml-4 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                  <li className="overflow-hidden">
                    <span className="mb-4 block"><strong>Problem-Solving Skills::</strong></span>
                    <div className="relative">
                      <div className="h-[10px] w-full rounded-[10px] bg-black"></div>
                      <div className="jos progress-bar absolute left-0 top-0 h-full rounded-[10px] bg-colorLightLime" data-percentage-value="95" data-jos_animation="slide-right">
                        <span className="absolute -top-12 left-full -translate-x-5 font-bold text-black">95%</span>
                      </div>
                    </div>
                  </li>
                  <li className="overflow-hidden">
                    <span className="mb-4 block"><strong>Networking Skills:</strong></span>
                    <div className="relative">
                      <div className="h-[10px] w-full rounded-[10px] bg-black"></div>
                      <div className="jos progress-bar absolute left-0 top-0 h-full rounded-[10px] bg-colorLightLime" data-percentage-value="83" data-jos_animation="slide-right">
                        <span className="absolute -top-12 left-full -translate-x-5 font-bold text-black">83%</span>
                      </div>
                    </div>
                  </li>
                  <li className="overflow-hidden">
                    <span className="mb-4 block"><strong>Leadership Skills:</strong></span>
                    <div className="relative">
                      <div className="h-[10px] w-full rounded-[10px] bg-black"></div>
                      <div className="jos progress-bar absolute left-0 top-0 h-full rounded-[10px] bg-colorLightLime" data-percentage-value="90" data-jos_animation="slide-right">
                        <span className="absolute -top-12 left-full -translate-x-5 font-bold text-black">90%</span>
                      </div>
                    </div>
                  </li>
                </ul>
