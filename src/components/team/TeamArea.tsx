      ...
      <div className="section-space">
        ...
        <div className="container">
          ...
          <ul className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {/* <!-- Team  Item --> */}
            <li className="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
            ...
            <li className="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
              <div className="relative overflow-hidden rounded-[20px] border-[5px] border-black">
                <img src="assets/img/images/th-1/team-img-5.jpg" alt="team-img-5" width="296" height="300" loading="lazy" className="h-full w-full object-cover transition-all duration-300 group-hover/team-item:scale-110" />
                {/* <!-- Social Link --> */}
                <div className="absolute top-full flex w-full justify-center gap-3 transition-all duration-300 group-hover/team-item:-translate-y-14">
                  <a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer" className="group/link relative inline-flex h-[34px] w-[34px] items-center justify-center rounded-[50%] border border-colorButteryWhite bg-black transition-all duration-300 hover:border-black hover:bg-colorLightLime hover:shadow-[0_1.5px_0_0] hover:shadow-colorButteryWhite">
                    <img src="assets/img/icons/icon-logo-buttery-white-twitter.svg" alt="icon-logo-buttery-white-twitter" width="19" height="16" className="opacity-100 transition-all duration-300 group-hover/link:opacity-0" />
            ...
            <li className="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
              <div className="relative overflow-hidden rounded-[20px] border-[5px] border-black">
                <img src="assets/img/images/th-1/team-img-6.jpg" alt="team-img-6" width="296" height="300" loading="lazy" className="h-full w-full object-cover transition-all duration-300 group-hover/team-item:scale-110" />
                {/* <!-- Social Link --> */}
                <div className="absolute top-full flex w-full justify-center gap-3 transition-all duration-300 group-hover/team-item:-translate-y-14">
                  <a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer" className="group/link relative inline-flex h-[34px] w-[34px] items-center justify-center rounded-[50%] border border-colorButteryWhite bg-black transition-all duration-300 hover:border-black hover:bg-colorLightLime hover:shadow-[0_1.5px_0_0] hover:shadow-colorButteryWhite">
                    <img src="assets/img/icons/icon-logo-buttery-white-twitter.svg" alt="icon-logo-buttery-white-twitter" width="19" height="16" className="opacity-100 transition-all duration-300 group-hover/link:opacity-0" />
            ...
            <li className="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
              <div className="relative overflow-hidden rounded-[20px] border-[5px] border-black">
                <img src="assets/img/images/th-1/team-img-7.jpg" alt="team-img-7" width="296" height="300" loading="lazy" className="h-full w-full object-cover transition-all duration-300 group-hover/team-item:scale-110" />
                {/* <!-- Social Link --> */}
                <div className="absolute top-full flex w-full justify-center gap-3 transition-all duration-300 group-hover/team-item:-translate-y-14">
                  <a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer" className="group/link relative inline-flex h-[34px] w-[34px] items-center justify-center rounded-[50%] border border-colorButteryWhite bg-black transition-all duration-300 hover:border-black hover:bg-colorLightLime hover:shadow-[0_1.5px_0_0] hover:shadow-colorButteryWhite">
                    <img src="assets/img/icons/icon-logo-buttery-white-twitter.svg" alt="icon-logo-buttery-white-twitter" width="19" height="16" className="opacity-100 transition-all duration-300 group-hover/link:opacity-0" />
            ...
            <li className="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
              <div className="relative overflow-hidden rounded-[20px] border-[5px] border-black">
                <img src="assets/img/images/th-1/team-img-8.jpg" alt="team-img-8" width="296" height="300" loading="lazy" className="h-full w-full object-cover transition-all duration-300 group-hover/team-item:scale-110" />
                {/* <!-- Social Link --> */}
                <div className="absolute top-full flex w-full justify-center gap-3 transition-all duration-300 group-hover/team-item:-translate-y-14">
                  <a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer" className="group/link relative inline-flex h-[34px] w-[34px] items-center justify-center rounded-[50%] border border-colorButteryWhite bg-black transition-all duration-300 hover:border-black hover:bg-colorLightLime hover:shadow-[0_1.5px_0_0] hover:shadow-colorButteryWhite">
                    <img src="assets/img/icons/icon-logo-buttery-white-twitter.svg" alt="icon-logo-buttery-white-twitter" width="19" height="16" className="opacity-100 transition-all duration-300 group-hover/link:opacity-0" />
            ...
            <li className="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
              <div className="relative overflow-hidden rounded-[20px] border-[5px] border-black">
                <img src="assets/img/images/th-1/team-img-9.jpg" alt="team-img-9" width="296" height="300" loading="lazy" className="h-full w-full object-cover transition-all duration-300 group-hover/team-item:scale-110" />
                {/* <!-- Social Link --> */}
                <div className="absolute top-full flex w-full justify-center gap-3 transition-all duration-300 group-hover/team-item:-translate-y-14">
                  <a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer" className="group/link relative inline-flex h-[34px] w-[34px] items-center justify-center rounded-[50%] border border-colorButteryWhite bg-black transition-all duration-300 hover:border-black hover:bg-colorLightLime hover:shadow-[0_1.5px_0_0] hover:shadow-colorButteryWhite">
                    <img src="assets/img/icons/icon-logo-buttery-white-twitter.svg" alt="icon-logo-buttery-white-twitter" width="19" height="16" className="opacity-100 transition-all duration-300 group-hover/link:opacity-0" />
              ...
              <div className="mt-5 text-center">
                <Link to="/team-details" className="display-heading display-heading-4 mb-4 block">Mark Strew</Link>
                <span className="text-lg md:text-[21px]">UI Designer</span>
              </div>
            </li>
            {/* <!-- Team  Item --> */}
            {/* <!-- Team  Item --> */}
            <li className="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
              <div className="relative overflow-hidden rounded-[20px] border-[5px] border-black">
                <img src="assets/img/images/th-1/team-img-10.jpg" alt="team-img-10" width="296" height="300" loading="lazy" className="h-full w-full object-cover transition-all duration-300 group-hover/team-item:scale-110" />
                {/* <!-- Social Link --> */}
                <div className="absolute top-full flex w-full justify-center gap-3 transition-all duration-300 group-hover/team-item:-translate-y-14">
                  <a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer" className="group/link relative inline-flex h-[34px] w-[34px] items-center justify-center rounded-[50%] border border-colorButteryWhite bg-black transition-all duration-300 hover:border-black hover:bg-colorLightLime hover:shadow-[0_1.5px_0_0] hover:shadow-colorButteryWhite">
                    <img src="assets/img/icons/icon-logo-buttery-white-twitter.svg" alt="icon-logo-buttery-white-twitter" width="19" height="16" className="opacity-100 transition-all duration-300 group-hover/link:opacity-0" />
              ...
              <div className="mt-5 text-center">
                <Link to="/team-details" className="display-heading display-heading-4 mb-4 block">Fradik Hazbag</Link>
                <span className="text-lg md:text-[21px]">Researcher</span>
              </div>
            </li>
            {/* <!-- Team  Item --> */}
            {/* <!-- Team  Item --> */}
            <li className="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
              <div className="relative overflow-hidden rounded-[20px] border-[5px] border-black">
                <img src="assets/img/images/th-1/team-img-11.jpg" alt="team-img-11" width="296" height="300" loading="lazy" className="h-full w-full object-cover transition-all duration-300 group-hover/team-item:scale-110" />
                {/* <!-- Social Link --> */}
                <div className="absolute top-full flex w-full justify-center gap-3 transition-all duration-300 group-hover/team-item:-translate-y-14">
                  <a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer" className="group/link relative inline-flex h-[34px] w-[34px] items-center justify-center rounded-[50%] border border-colorButteryWhite bg-black transition-all duration-300 hover:border-black hover:bg-colorLightLime hover:shadow-[0_1.5px_0_0] hover:shadow-colorButteryWhite">
                    <img src="assets/img/icons/icon-logo-buttery-white-twitter.svg" alt="icon-logo-buttery-white-twitter" width="19" height="16" className="opacity-100 transition-all duration-300 group-hover/link:opacity-0" />
              ...
              <div className="mt-5 text-center">
                <Link to="/team-details" className="display-heading display-heading-4 mb-4 block">Sam Kainiz</Link>
                <span className="text-lg md:text-[21px]">Lead Developer</span>
              </div>
            </li>
            {/* <!-- Team  Item --> */}
            {/* <!-- Team  Item --> */}
            <li className="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
              <div className="relative overflow-hidden rounded-[20px] border-[5px] border-black">
                <img src="assets/img/images/th-1/team-img-12.jpg" alt="team-img-12" width="296" height="300" loading="lazy" className="h-full w-full object-cover transition-all duration-300 group-hover/team-item:scale-110" />
                {/* <!-- Social Link --> */}
                <div className="absolute top-full flex w-full justify-center gap-3 transition-all duration-300 group-hover/team-item:-translate-y-14">
                  <a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer" className="group/link relative inline-flex h-[34px] w-[34px] items-center justify-center rounded-[50%] border border-colorButteryWhite bg-black transition-all duration-300 hover:border-black hover:bg-colorLightLime hover:shadow-[0_1.5px_0_0] hover:shadow-colorButteryWhite">
                    <img src="assets/img/icons/icon-logo-buttery-white-twitter.svg" alt="icon-logo-buttery-white-twitter" width="19" height="16" className="opacity-100 transition-all duration-300 group-hover/link:opacity-0" />
              ...
              <div className="mt-5 text-center">
                <Link to="/team-details" className="display-heading display-heading-4 mb-4 block">Mac Jackson</Link>
                <span className="text-lg md:text-[21px]">Marketing Expert</span>
              </div>
            </li>
            {/* <!-- Team  Item --> */}
          </ul>
