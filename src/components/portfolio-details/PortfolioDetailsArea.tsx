      ...
      <section className="section-portfolio">
        ...
        <div className="section-space">
          ...
          <div className="container">
            ...
            <div className="overflow-hidden rounded-[31px] border-[5px] border-black">
              <img src="assets/img/images/th-1/project-details-hero-img.jpg" alt="project-details-hero-img" className="h-auto w-full" />
            </div>
            {/* <!-- Portfolio Hero Image Block --> */}

            {/* <!-- Project Details Info List --> */}
            <ul className="mb-10 mt-10 flex flex-wrap justify-between gap-x-5 gap-y-2 md:mb-[60px] lg:mb-20">
            ...
            {/* <!-- Content Block --> */}
            <div className="grid grid-cols-1 gap-14 lg:grid-cols-[1fr_minmax(0,440px)]">
              {/* <!-- Content Left Block --> */}
              <div>
                {/* <!-- Section Block --> */}
                ...
                <ul className="flex flex-col gap-y-8">
                  <li>
                    <h4 className="mb-4">Concept Development:</h4>
                    <p>
                  ...
                  <li>
                    <h4 className="mb-4">Manufacturing and Production:</h4>
                    <p>
                  ...
                  <li>
                    <h4 className="mb-4">Success and Impact:</h4>
                    <p>
              ...
              {/* <!-- Content Left Block --> */}
              {/* <!-- Content Right Block --> */}
              <div className="mx-auto max-w-[450px] overflow-hidden rounded-[23px] border-[5px] border-black lg:mx-0 lg:max-w-full">
                <img src="assets/img/images/th-1/portfolio-content-img.jpg" alt="portfolio-content-img" width="456" height="736" className="h-auto w-full object-cover lg:h-full" />
              </div>
              {/* <!-- Content Right Block --> */}
            </div>
            {/* <!-- Content Block --> */}
