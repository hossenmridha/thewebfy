...
export default function HeaderSeven() {
  ...
  return (
    <header className={`section-header site-header is-transparent fixed top-0 z-30 w-full bg-transparent py-2 ${sticky ? 'scrolling' : ''}`}>
      {/* <!-- Section Container --> */}
      <div className="container">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-x-6">
            <Link to="/contact" className="group hidden rounded border-2 border-[#4659FF] bg-[#4659FF] px-6 py-3 text-base font-bold text-white lg:inline-flex lg:px-8 xl:px-[42px]">
              <div className="relative flex items-center justify-center overflow-hidden">
                <span className="translate-y-0 transition-all duration-300 group-hover:-translate-y-full">Hire Us!</span>
                <span className="absolute translate-y-full transition-all duration-300 group-hover:translate-y-0">Hire Us!</span>
              </div>
            </Link>
