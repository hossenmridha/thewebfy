...
export default function HeaderEight() {
  ...
  return (
    <header className={`section-header site-header fixed top-0 z-30 w-full bg-[#FCF9F0] py-2 ${sticky ? 'scrolling' : ''}`}>
      {/* <!-- Section Container --> */}
      <div className="container">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-x-6">
            <Link to="/contact" className="group hidden rounded border-2 border-[#001AA5] bg-[#001AA5] px-6 py-3 text-base font-bold text-white lg:inline-flex lg:px-8 xl:px-[42px]">
