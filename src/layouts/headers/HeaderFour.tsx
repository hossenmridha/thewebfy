...
export default function HeaderFour() {
  ...
  return (
    <>
      <header className={`section-header site-header fixed top-0 z-30 w-full bg-[#FFF7EA] py-2 ${sticky ? 'scrolling' : ''}`}>
        {/* <!-- Section Container --> */}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-x-6">
              <div className="hidden sm:inline-block">
                <button onClick={() => setIsOpenOffCanvas(true)} id="offcanvas-open-btn" className="flex items-center gap-[10px] rounded-[50px] border-2 border-[#191931] px-6 py-3 text-base font-bold">
                  <img src="assets/img/icons/icon-menu-alt-1.svg" alt="icon-menu-alt-1" width="24" height="24" />
                  Menu
                </button>
              </div>
      ...
      <OffCanvas isOpenOffCanvas={isOpenOffCanvas} setIsOpenOffCanvas={setIsOpenOffCanvas} />
    </>
  )
}
