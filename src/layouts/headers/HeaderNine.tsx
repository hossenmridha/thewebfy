...
export default function HeaderNine() {
  ...
  return (
    <header className={`section-header site-header fixed top-0 z-30 w-full bg-[#FEF6E0] py-2 ${sticky ? 'scrolling' : ''}`}>
      {/* <!-- Section Container --> */}
      <div className="container">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-x-6">
            <Link to="/contact" className="group hidden rounded border-2 border-[#FF5317] bg-[#FF5317] px-6 py-3 text-base font-bold text-white lg:inline-flex lg:px-8 xl:px-[42px]">
