...
export default function HeaderOne({ menu_color }: NavmenuProps) {
  ...
  return (
    <>
      <header
        className={`section-header site-header is-black fixed top-0 z-30 w-full py-2 ${sticky ? "scrolling" : ""
          }`}
      >
        <div className="container">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-x-10">
              {/* Logo */}
              <Link to="/">
                <img src="assets/img/logo-new.svg" alt="logo" width="121" height="24" />
              </Link>
