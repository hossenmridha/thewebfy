...
export default function HeaderTwo() {
  ...
  return (
    <>
      <header className={`section-header site-header is-white fixed top-0 z-30 w-full py-2 ${sticky ? 'scrolling' : ''}`}>
        {/* <!-- Section Container --> */}
        <div className="container">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-x-6">
              <Link to="/contact" className="btn-outline-black-2 hidden sm:inline-flex">Hire Us</Link>
